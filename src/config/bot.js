...
export const botConfig = {
    ...
    activities: [
      {
        ...
        name: "Watching over Pixel Studios!","Helping People in Pixel Studios","Join Pixel Studios now!",
  ...
  applications: {
    ...
    defaultQuestions: [
      ...
      { question: "How old are you? -not required-", required: false },
    ...
    managerRoles: [1400185845679394945], // Will be populated from environment or database
  },
